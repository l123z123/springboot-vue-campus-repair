<template>
  <div class="help-page">
    <el-row :gutter="20">
      <el-col :xs="24" :md="14">
        <el-card shadow="never" class="help-card">
          <template #header><span class="help-card__title">常见问题</span></template>
          <p class="help-desc">如有问题或建议，请先查看以下常见问题解答。</p>
          <el-collapse>
            ...
            <el-collapse-item title="对维修结果不满意怎么办？" name="4">
              <p>确认维修完成时，您可以在评价中给出真实评分和意见。如有严重问题，也可以通过右侧反馈表单提交申诉，管理员会跟进处理。</p>
            </el-collapse-item>
          </el-collapse>
        </el-card>
      </el-col>
      ...
      <el-col :xs="24" :md="10">
        <el-card shadow="never" class="help-card">
          <template #header><span class="help-card__title">意见反馈</span></template>
          <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
            <el-form-item label="反馈内容" prop="content">
              <el-input v-model="form.content" type="textarea" :rows="5" placeholder="请简要描述您的问题或建议..." maxlength="500" show-word-limit />
            </el-form-item>
    ...
    <el-row v-if="recentList.length" style="margin-top: 20px">
      <el-col :span="24">
        <el-card shadow="never" class="help-card">
...
.help-card__title { font-size: 16px; font-weight: 600; }
...
.help-card :deep(.el-collapse-item__content) p {
  margin: 0;
  font-size: 14px;
  color: var(--el-text-color-regular);
  line-height: 1.6;
